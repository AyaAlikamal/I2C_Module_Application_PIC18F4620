...
# 11 "./ECU_Layer/LED/ecu_led_cfg.h"
...
# 10 "./ECU_Layer/LED/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 44 "./ECU_Layer/LED/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
# 11 "./ECU_Layer/LED/ecu_led_cfg.h" 2
...
# 11 "./ECU_Layer/ecu_init.h" 2

# 1 "./ECU_Layer/Button/ecu_button.h" 1
# 10 "./ECU_Layer/Button/ecu_button.h"
# 1 "./ECU_Layer/Button/ecu_button_cfg.h" 1
# 10 "./ECU_Layer/Button/ecu_button.h" 2
...
# 20 "./ECU_Layer/Relay/ecu_relay.h"
typedef struct {
    uint_8 Relay_Port :4;
    uint_8 Relay_Pin :3;
...
# 1 "./ECU_Layer/Motor/ecu_dc_motor.h" 1
# 13 "./ECU_Layer/Motor/ecu_dc_motor.h"
# 1 "./ECU_Layer/Motor/ecu_dc_motor_cfg.h" 1
# 13 "./ECU_Layer/Motor/ecu_dc_motor.h" 2
# 29 "./ECU_Layer/Motor/ecu_dc_motor.h"
typedef struct{
...
# 1 "./ECU_Layer/7_Segment/ecu_7segment.h" 1
# 13 "./ECU_Layer/7_Segment/ecu_7segment.h"
# 1 "./ECU_Layer/7_Segment/ecu_7segment_cfg.h" 1
# 13 "./ECU_Layer/7_Segment/ecu_7segment.h" 2
# 25 "./ECU_Layer/7_Segment/ecu_7segment.h"
typedef enum {
...
# 1 "./ECU_Layer/Keypad/ecu_kypad_cfg.h" 1
# 12 "./ECU_Layer/Keypad/ecu_keypad.h" 2
# 21 "./ECU_Layer/Keypad/ecu_keypad.h"
typedef struct {
pin_config_t keypad_rows[4];
pin_config_t keypad_columns[4];
}keypad_t;
...
# 80 "./MCAL_Layer/interrupt/mcal_external_interrupt.h"
typedef enum{
...
# 1 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\\pic\\include\\../../pic/include/proc/pic18f4620.h" 1 3
# 14 "./MCAL_Layer/ADC/hal_adc.h" 2
# 65 "./MCAL_Layer/ADC/hal_adc.h"
typedef enum{
    ADC_CHANNEL_AN0 = 0,
    ADC_CHANNEL_AN1,
    ADC_CHANNEL_AN2,
...
# 1 "./MCAL_Layer/Timer/hal_Time0.h" 1
# 37 "./MCAL_Layer/Timer/hal_Time0.h"
typedef enum{
...
# 40 "./MCAL_Layer/Timer1/hal_timer1.h"
typedef enum{
...
# 11 "./MCAL_Layer/CCP1/hal_ccp1.h"
# 1 "./MCAL_Layer/CCP1/hal_ccp1_cfg.h" 1
# 11 "./MCAL_Layer/CCP1/hal_ccp1.h" 2
# 61 "./MCAL_Layer/CCP1/hal_ccp1.h"
typedef enum{
    CCP1_Module = 0,
    CCP2_Module
}ccp_cfg_t;
...
# 1 "./MCAL_Layer/UART/hal_uart.h" 1
# 12 "./MCAL_Layer/UART/hal_uart.h"
# 1 "./MCAL_Layer/UART/hal_uart_cfg.h" 1
# 12 "./MCAL_Layer/UART/hal_uart.h" 2
# 58 "./MCAL_Layer/UART/hal_uart.h"
typedef enum{
...
mssp_i2c_t i2c_obj;
static volatile uint_8 slave1_data ;
...
Std_ReturnType ret = (Std_ReturnType)0x01;
   ...
   i2c_obj.I2c_Receive_Overflow = ((void*)0);
   i2c_obj.I2c_Write_Collision = ((void*)0);
   i2c_obj.i2c_cfg.i2c_mode = 0;
   ...
   i2c_obj.i2c_cfg.i2c_general_call = 0;
