...
#define EUSART_RX_LOW_PRIORITY_SET()    (IPR1bits.RCIP = 0)
  ...
  /*Disable interrupt routine for MSSP_I2C module*/
#define MSSP_I2C_INTERRUPT_DISABLE()         (PIE1bits.SSPIE = 0)
#define MSSP_I2C_BUS_COL_INTERRUPT_DISABLE() (PIE2bits.BCLIE = 0)
/*Enable interrupt routine for MSSP_I2C module*/
#define MSSP_I2C_INTERRUPT_ENABLE()          (PIE1bits.SSPIE = 1)
#define MSSP_I2C_BUS_COL_INTERRUPT_ENABLE()  (PIE2bits.BCLIE = 1)
/*Clear the interrupt flag*/
#define MSSP_I2C_CLEAR_FLAG()                (PIR1bits.SSPIF = 0)
#define MSSP_I2C_BUS_COL_CLEAR_FLAG()        (PIR2bits.BCLIF = 0)
#ifdef INTERRUPT_PRIORITY_LEVELS_ENABLE == INTERRUPT_FEATURE_ENABLE
#define MSSP_I2C__HIGH_PRIORITY_SET()        (IPR1bits.SSPIP = 1)
